...
FIELD_CONFIG = [
  ...
  { "id": 1003, "name": 'totals.plan', "label": '本期计划', "type": 'totals', "component": 'display', "formula": 'VAL(2001)+VAL(2003)+VAL(2005)+VAL(2007)+VAL(2009)+VAL(2011)+VAL(2013)' },
  { "id": 1004, "name": 'totals.samePeriod', "label": '同期完成', "type": 'totals', "component": 'display', "formula": 'VAL(2002)+VAL(2004)+VAL(2006)+VAL(2008)+VAL(2010)+VAL(2012)+VAL(2014)' },
  { "id": 1005, "name": 'totals.diffRate', "label": '差异率', "type": 'diffs', "component": 'display', "displayFormat": { 'type': 'percentage', 'places': 2 }, "formula": '(VAL(1003)-VAL(1004))/VAL(1004)' },
