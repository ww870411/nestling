...
export const reportTemplate = [
  { id: 1, category: '气温', name: '月平均高温', unit: '℃', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: true, requiredProperties: {businessModel: ['independent']}, columnFormulaOverrides: { 'totals.plan': 'AVG(2003, 2005, 2007, 2009, 2011, 2013)', 'totals.samePeriod': 'AVG(2004, 2006, 2008, 2010, 2012, 2014)' } , validation: { soft: [] }},
  { id: 2, category: '气温', name: '月平均低温', unit: '℃', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: true, requiredProperties: {businessModel: ['independent']}, columnFormulaOverrides: { 'totals.plan': 'AVG(2003, 2005, 2007, 2009, 2011, 2013)', 'totals.samePeriod': 'AVG(2004, 2006, 2008, 2010, 2012, 2014)' } , validation: { soft: [] } },
