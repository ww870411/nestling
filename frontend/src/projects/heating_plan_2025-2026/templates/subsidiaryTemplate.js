...
export const reportTemplate = [
  { id: 1, category: '气温', name: '月平均高温', unit: '℃', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {}, columnFormulaOverrides: { 'totals.plan': 'AVG(2001, 2003, 2005, 2007, 2009, 2011, 2013)', 'totals.samePeriod': 'AVG(2002, 2004, 2006, 2008, 2010, 2012, 2014)' } , validation: { soft: [] }},
  { id: 2, category: '气温', name: '月平均低温', unit: '℃', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {}, columnFormulaOverrides: { 'totals.plan': 'AVG(2001, 2003, 2005, 2007, 2009, 2011, 2013)', 'totals.samePeriod': 'AVG(2002, 2004, 2006, 2008, 2010, 2012, 2014)' } , validation: { soft: [] } },
  ...
  { id: 8, category: '产量', name: '其中：1.供汽量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [] }},
  { id: 9, category: '产量', name: '2.高温水供热量', unit: 'GJ', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['thermoelectric'] } , validation: { soft: [] }},
  { id: 10, category: '产量', name: '3.低真空供热量', unit: 'GJ', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['thermoelectric'] } , validation: { soft: [] }},
  { id: 11, category: '产量', name: '4.低温水供热量', unit: 'GJ', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['boiler_room'] } , validation: { soft: [] }},
  ...
  { id: 14, category: '销量', name: '售汽量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['heating_company'] } , validation: { soft: [] }},
  { id: 15, category: '销量', name: '关联交易汽量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['heating_company'] } , validation: { soft: [] }},
  { id: 16, category: '销量', name: '关联交易高温水量', unit: 'GJ', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['heating_company'] } , validation: { soft: [] }},
  { id: 17, category: '销量', name: '期末挂网面积', unit: '㎡', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['heating_company'] }, columnFormulaOverrides: { 'totals.plan': 'LAST_VAL(2001, 2003, 2005, 2007, 2009, 2011, 2013)', 'totals.samePeriod': 'LAST_VAL(2002, 2004, 2006, 2008, 2010, 2012, 2014)' }, validation: { soft: [] } },
  ...
  { id: 24, category: '销量', name: '高温水销售量', unit: 'GJ', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['heating_company'] } , validation: { soft: [] }},
  ...
  { id: 50, category: '主要物料消耗量', name: '耗酸量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  { id: 51, category: '主要物料消耗量', name: '耗碱量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  { id: 52, category: '主要物料消耗量', name: '耗石灰石量（粗）', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  { id: 53, category: '主要物料消耗量', name: '耗石灰石粉量（细）', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  { id: 54, category: '主要物料消耗量', name: '耗氨水量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  { id: 55, category: '主要物料消耗量', name: '耗氧化镁量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  { id: 56, category: '主要物料消耗量', name: '耗脱硝剂量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  { id: 57, category: '主要物料消耗量', name: '耗阻垢剂量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  { id: 58, category: '主要物料消耗量', name: '耗杀菌剂量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  ...
  { id: 67, category: '主要物料消耗量', name: '2.2供热厂用电量', unit: '万kWh', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['thermoelectric'] } , validation: { soft: [] }},
  ...
  { id: 99, category: '经济指标', name: '售汽收入', unit: '万元', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['heating_company'], businessModel: ['independent'] }, validation: { soft: [] } },
