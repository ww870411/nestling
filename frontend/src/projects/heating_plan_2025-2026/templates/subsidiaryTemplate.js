...
export const reportTemplate = [
  ...
  { id: 44, category: '主要物料消耗量', name: '2.2低真空补水量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['thermoelectric'],special:['low vacuum'] } },
