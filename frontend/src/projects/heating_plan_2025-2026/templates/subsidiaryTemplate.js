...
export const reportTemplate = [
  ...
  { id: 80, category: '比率', name: '发电设备利用率', unit: '%',displayFormat: { type: 'percentage', places: 2 }, type: 'calculated', formula: 'VAL(6)/VAL(3)/3744', style: { fontWeight: 'bold' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['thermoelectric'] }, validation: { soft: [{ rule: 'totals.plan >= totals.samePeriod ', message: '本期计划应不低于同期。' }] } },
  { id: 81, category: '比率', name: '供热设备利用率', unit: '%', displayFormat: { type: 'percentage', places: 2 },type: 'calculated', formula: 'VAL(7)*1000/(VAL(4)+VAL(5))/13478400', style: { fontWeight: 'bold' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [] }},
