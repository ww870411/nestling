...
export const reportTemplate = [
  ...
  { id: 20, category: '销量', name: '2.高温水站面积', unit: '㎡', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['heating_company'],special:['jinpu'] } , columnFormulaOverrides: { 'totals.plan': 'LAST_VAL(2001, 2003, 2005, 2007, 2009, 2011, 2013)', 'totals.samePeriod': 'LAST_VAL(2002, 2004, 2006, 2008, 2010, 2012, 2014)' }, validation: { soft: [] }},
  { id: 21, category: '销量', name: '3.低真空站面积', unit: '㎡', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['heating_company'] }, columnFormulaOverrides: { 'totals.plan': 'LAST_VAL(2001, 2003, 2005, 2007, 2009, 2011, 2013)', 'totals.samePeriod': 'LAST_VAL(2002, 2004, 2006, 2008, 2010, 2012, 2014)' } , validation: { soft: [] }},
  { id: 22, category: '销量', name: '4.低温水供热面积', unit: '㎡', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['boiler_room'],fuelType: ['coal']  } , columnFormulaOverrides: { 'totals.plan': 'LAST_VAL(2001, 2003, 2005, 2007, 2009, 2011, 2013)', 'totals.samePeriod': 'LAST_VAL(2002, 2004, 2006, 2008, 2010, 2012, 2014)' }, validation: { soft: [] }},
  ...
  { id: 31, category: '主要物料消耗量', name: '1.2油折标煤耗量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: { productionMethod: ['thermoelectric','elec_boiler_room']} },
  ...
  { id: 52, category: '主要物料消耗量', name: '耗石灰石量（粗）', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {productionMethod: ['thermoelectric','elec_boiler_room']} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  ...
  { id: 55, category: '主要物料消耗量', name: '耗氧化镁量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {productionMethod: ['thermoelectric','elec_boiler_room']} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  { id: 56, category: '主要物料消耗量', name: '耗脱硝剂量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {productionMethod: ['thermoelectric','elec_boiler_room']} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  { id: 57, category: '主要物料消耗量', name: '耗阻垢剂量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {productionMethod: ['thermoelectric','elec_boiler_room']} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  { id: 58, category: '主要物料消耗量', name: '耗杀菌剂量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {productionMethod: ['thermoelectric','elec_boiler_room']} , validation: { soft: [{ rule: 'totals.plan <= totals.samePeriod * 0.9', message: '本期计划不应超过同期的90%。' }] }},
  { id: 59, category: '主要物料消耗量', name: '耗钢球量', unit: '吨', type: 'basic', formula: null, style: { fontWeight: 'normal' }, samePeriodEditable: false, requiredProperties: {productionMethod: ['thermoelectric']} },
