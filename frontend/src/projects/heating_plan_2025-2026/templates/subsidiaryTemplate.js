...
export const reportTemplate = [
  ...
  { id: 7, category: '产量', name: '供热量', unit: 'GJ', type: 'calculated', formula: 'VAL(8)*2.952+VAL(9)+VAL(10)+VAL(11)+VAL(12)', style: { fontWeight: 'bold' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [] }},
  ...
  { id: 75, category: '比率', name: '生产产出率', unit: '%', displayFormat: { type: 'percentage', places: 2 },type: 'calculated', formula: '(VAL(7)+VAL(13)*36)/29.308/VAL(28)', style: { fontWeight: 'bold' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [{ rule: 'totals.plan => totals.samePeriod ', message: '本期计划应不低于同期。' }] }},
  { id: 76, category: '比率', name: '综合产出率', unit: '%', displayFormat: { type: 'percentage', places: 2 },type: 'calculated', formula: '(VAL(13)*36+VAL(14)*2.952+VAL(24)+VAL(61))/29.308/VAL(28)', style: { fontWeight: 'bold' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [{ rule: 'totals.plan => totals.samePeriod ', message: '本期计划应不低于同期。' }] }},
  { id: 77, category: '比率', name: '全厂热效率', unit: '%', displayFormat: { type: 'percentage', places: 2 },type: 'calculated', formula: '(VAL(7)+VAL(13)*36)/(VAL(28)*29.308)', style: { fontWeight: 'bold' }, samePeriodEditable: false, requiredProperties: {} , validation: { soft: [{ rule: 'totals.plan => totals.samePeriod ', message: '本期计划应不低于同期。' }] }},
